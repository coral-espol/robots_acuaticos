...
class SwarmDataLogger(Node):
    def __init__(self):
        ...
        # Configuration
        self.num_robots = 5  # Number of robots in the swarm
        ...
        self.csv_filename = os.path.join(self.data_dir, f'swarm_data_model2_{timestamp}.csv')
        ...
        # Subscribers to the odometry of all robots (model2 uses /robot{i}/odometry)
        ...
        self.get_logger().info(f'Swarm Data Logger initialized for Model 2')
        self.get_logger().info(f'Data will be saved to: {self.csv_filename}')
        self.get_logger().info(f'Listening to {self.num_robots} robots')
    ...
    def print_stats(self):
        ...
        self.get_logger().info(f'Time: {current_time:.1f}s | Data points: {self.data_count} | Rate: {rate:.1f} Hz')
    ...
    def generate_summary(self):
        ...
        try:
            ...
            with open(summary_filename, 'w') as f:
                f.write("SWARM BEHAVIOR DATA SUMMARY - MODEL 2\n")
                f.write("=" * 50 + "\n\n")
                ...
                f.write("- robot_name: Robot name (robot1 to robot5)\n")
